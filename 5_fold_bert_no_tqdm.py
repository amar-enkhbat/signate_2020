# -*- coding: utf-8 -*-
"""5_fold_BERT_no_tqdm.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ngC9xKVhTPUXvnbAgBebJHP9nBMn78QV
"""

# !pip install transformers nlp
# !mkdir figures input models notebooks output result
...
# test_df = pd.read_csv("./input/new_train_ja_de_2.csv", usecols=["id", "description", "jobflag"])
# test_df = pd.read_csv("./input/new_train_ja_de_2.csv")
# test_df.head()
# test_df.to_csv("./input/new_train_ja_de_2.csv", index=False)
...
def train_fn(dataloader, model, criterion, optimizer, scheduler, device, epoch):
    ...
    for i, batch in enumerate(dataloader):
        ...
        print(f"Loss={total_loss/(i+1)}, f1={f1_score(all_labels, all_preds, average='macro')}")
...
fig, axs = plt.subplots(NUM_SPLITS, EPOCHS, figsize=(10, 20))
for i in range(NUM_SPLITS):
  axs[i].plot(range(EPOCHS), hist[i])
plt.show()
